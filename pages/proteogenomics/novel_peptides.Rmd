...
For this tutorial, the _Novel Peptides_ table was extracted to an R-friendly text format, and is available in [resources/data/novel_peptides.txt](resources/data/novel_peptides.txt).
